...
CREATE TABLE `likeposts` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_like_id_idx` (`user_like_post_id`),
...
CREATE TABLE `users` (
  ...
  `motdepasse` varchar(234) NOT NULL,
  `fonction` varchar(45) NOT NULL,
  `photo` varchar(100) DEFAULT 'http://localhost:3000/images/default-profile.jpg',
  `biographie` varchar(250) DEFAULT 'Pas de biographie écrite pour le moment.',
